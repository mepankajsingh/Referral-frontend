...
export default function ReferralDetailPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-indigo-50 via-indigo-100 to-indigo-50">
      ...
      {/* Referral Code Section - Reduced size but still prominent */}
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center">
                <div className="flex items-center space-x-4 flex-grow w-full sm:w-auto">
                  <div className="flex items-center">
                    ...
                    <h2 className="text-sm font-bold text-gray-900">Referral Code:</h2>
                  </div>
                  
                  <div className="flex items-center flex-grow max-w-xl">
                    <div className="bg-gray-50 px-3 py-1.5 rounded border border-gray-200 flex-grow">
                      <code className="text-base font-mono text-indigo-800 font-semibold select-all">
                        {referral.code}
                      </code>
                    </div>
                    <button 
                      onClick={handleCopyCode}
                      className={`ml-2 px-3 py-1.5 rounded flex items-center transition-colors ${
                        copied 
                    ...
                    {/* Play Store image - shown inline on desktop, below on mobile */}
                    {referral.url && (
                      <a 
                        href={referral.url} 
                        target="_blank" 
                      ...
                      >
                        <img 
                          src="https://res.cloudinary.com/referral/image/upload/v1744897341/playstore_w4mlj7.png" 
                ...
                {/* Play Store image - shown only on mobile */}
                {referral.url && (
                  <a 
                    href={referral.url} 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex sm:hidden items-center mt-3 ml-6"
                  >
                    <img 
                      src="https://res.cloudinary.com/referral/image/upload/v1744897341/playstore_w4mlj7.png" 
                      alt="Download from Play Store" 
