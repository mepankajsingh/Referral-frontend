    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-12">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-4">ReferBonus</h3>
            <p className="text-gray-600 mb-4">
              Find and share referral codes for your favorite apps and services.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/featured" className="text-gray-600 hover:text-indigo-600">
                  Featured Offers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/category/food-delivery" className="text-gray-600 hover:text-indigo-600">
                  Food Delivery
                </Link>
              </li>
              <li>
                <Link to="/category/ride-sharing" className="text-gray-600 hover:text-indigo-600">
                  Ride Sharing
                </Link>
              </li>
              <li>
                <Link to="/category/finance" className="text-gray-600 hover:text-indigo-600">
                  Finance
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">
            © {currentYear} ReferBonus. All rights reserved.
          </p>
